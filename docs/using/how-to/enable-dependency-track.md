...
You already run a Dependency Track instance (self-hosted or managed) and want this project's releases to appear there automatically. If you don't have a server, see [SBOM and security model](../explanation/sbom-and-security-model.md) (inner-project explanation) for what you're missing first.
