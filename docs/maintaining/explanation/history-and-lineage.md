...
- A practical walkthrough as the primary documentation surface (now split across [Tutorials](../../using/tutorials/generate-your-first-project.md) and [How-to](../../using/how-to/update-existing-project-with-copier.md)).
