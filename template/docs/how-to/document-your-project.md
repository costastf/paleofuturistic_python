...
(the `_CI` tasks, uv, testing, SBOMs), see [The scaffold](../explanation/the-scaffold.md).
...
The template ships a few starter pages so the site isn't empty on day one. Treat them as scaffolding to
edit or delete, not as content to keep:

- [About your project](../explanation/about-your-project.md) — a fill-in-the-blanks explanation page with
  inline coaching comments. Make it yours, then delete the comments.
- The example tutorial and how-to pages describe the scaffold itself; once your project does something
  real, replace them with tutorials and how-tos about *your* software.

## See also

- [Preview docs locally](preview-docs-locally.md) — build and live-reload the site while you write.
- [The scaffold](../explanation/the-scaffold.md) — the tooling behind properdocs and the rest of the project.
