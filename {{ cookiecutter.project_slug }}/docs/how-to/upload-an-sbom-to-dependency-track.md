...
Re-run `uvx cruft update` and answer `y` to `integrate_dependency_track`. See [cruft's update docs](https://cruft.github.io/cruft/#updating-a-project) for the full workflow.
